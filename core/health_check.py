...
VALIDATION_MESSAGES = {
    ...
    "GEMINI_API_KEY_MISSING": "❌ Gemini API key is not set (configure in Settings)",
    "OPENROUTER_API_KEY_MISSING": "❌ OpenRouter API key is not set (configure in Settings)",
    "PCAPDROID_API_KEY_MISSING": "❌ PCAPdroid API key is not set (configure in Settings)",
    "MOBSF_API_KEY_MISSING": "❌ MobSF API key is not set (configure in Settings)",
