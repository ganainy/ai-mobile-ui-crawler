...
## Active Technologies
- Python 3.11 + PySide6 (Qt), Pillow, easyocr (025-stats-and-stability)
...
- Python 3.12 + PyQt6, requests, asyncio (024-crawl-stability-fixes)
...
- 025-stats-and-stability: Added Python 3.11 + PySide6 (Qt), Pillow, easyocr

- 024-crawl-stability-fixes: Added Python 3.12 + PyQt6, requests, asyncio
