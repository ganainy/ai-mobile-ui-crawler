...
START_CMD_ENABLE_AI_RUN_REPORT_ARG = "--enable-ai-run-report"
START_CMD_ENABLE_AI_RUN_REPORT_HELP = "Enable AI-generated run report after crawl completes"
...
RESET_CONFIG_CONFIRM_PROMPT = "This will delete all configuration values, crawler actions, and prompts. Continue? (yes/no): "
