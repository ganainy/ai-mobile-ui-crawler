---
generated: true
file: src/mobile_crawler/domain/crawler_agent/agent/manager/manager_agent.py
---
# mobile_crawler.domain.crawler_agent.agent.manager.manager_agent

ManagerAgent - Planning and reasoning workflow.

Source: `src/mobile_crawler/domain/crawler_agent/agent/manager/manager_agent.py`
...
- [[code/domain/crawler_agent/agent/manager/prompts|domain.crawler_agent.agent.manager.prompts]]
- [[code/domain/crawler_agent/agent/tool_registry|domain.crawler_agent.agent.tool_registry]]
- [[code/domain/crawler_agent/agent/usage|domain.crawler_agent.agent.usage]]
- [[code/domain/crawler_agent/agent/utils/chat_utils|domain.crawler_agent.agent.utils.chat_utils]]
...
- [[code/domain/crawler_agent/app_cards/app_card_provider|domain.crawler_agent.app_cards.app_card_provider]]
- [[code/domain/crawler_agent/app_cards/providers/_index|domain.crawler_agent.app_cards.providers]]
