---
generated: true
file: src/mobile_crawler/domain/traffic_capture_manager.py
---
# mobile_crawler.domain.traffic_capture_manager

Traffic capture manager for PCAPdroid integration.

Source: `src/mobile_crawler/domain/traffic_capture_manager.py`
