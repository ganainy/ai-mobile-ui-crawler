...
generated: partial
---
# mobile_crawler.cli.commands

<!-- summary:start -->
_Add a one-line summary of this package here._
<!-- summary:end -->

## Modules
- [[code/cli/commands/config|cli.commands.config]] - CLI commands for configuration management.
- [[code/cli/commands/crawl|cli.commands.crawl]]
- [[code/cli/commands/delete|cli.commands.delete]] - CLI command for deleting runs.
- [[code/cli/commands/list|cli.commands.list]] - CLI commands for listing runs, devices and installed apps.
