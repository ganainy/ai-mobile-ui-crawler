...
try:
    ...
    MOBILERUN_AVAILABLE = True
except ImportError:
    MOBILERUN_AVAILABLE = False
    AsyncMobilerun = None
...
class CloudDriver(DeviceDriver):
    ...
    def __init__(
        ...
        if not MOBILERUN_AVAILABLE:
            raise ImportError("MobileRun SDK is not installed. Please run pip install mobilerun-sdk to use the CloudDriver.")
