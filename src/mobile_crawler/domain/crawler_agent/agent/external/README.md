...
External agents are self-contained modules that receive raw ADB access and run independently from `crawler_agent`'s internal tools.

## Quick Start

1. Add your agent as a file or folder in this directory
2. Configure it in the configuration under `external_agents.<name>`
...
- **Zero imports from `crawler_agent`** — your agent must be fully self-contained
