...
from mobile_crawler.domain.crawler_agent.config_manager.config_manager import TracingConfig
...
def _setup_phoenix_tracing() -> bool:
    ...
    try:
        from mobile_crawler.domain.crawler_agent.telemetry.phoenix import arize_phoenix_callback_handler
    except ImportError:
        logger.warning(
