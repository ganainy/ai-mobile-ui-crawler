...
-- Description: Initial database schema for crawler.db
-- Created: 2026-01-10
...
CREATE INDEX IF NOT EXISTS idx_step_logs_run ON step_logs(run_id, step_number);
CREATE INDEX IF NOT EXISTS idx_screens_hash ON screens(composite_hash);
CREATE INDEX IF NOT EXISTS idx_transitions_run ON transitions(run_id);
CREATE INDEX IF NOT EXISTS idx_run_stats_run ON run_stats(run_id);
CREATE INDEX IF NOT EXISTS idx_ai_interactions_run ON ai_interactions(run_id, step_number);